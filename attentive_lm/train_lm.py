...
model_name = "lm_lstm_2lr_emb_512_hid512_proj256_en10000_maxNrm1_adam_0-01_dropout-off_input-feed-off-data-PTB"
...
flags.DEFINE_float("learning_rate", 0.01, "The learning rate used when updating the LM parameters.")
...
tf.app.flags.DEFINE_integer('steps_per_checkpoint', 0, 'How many training steps to do per checkpoint. Set to 0 to save only after each epoch.')
tf.app.flags.DEFINE_integer('steps_per_validation', 0, 'How many training steps to do between each validation.')
