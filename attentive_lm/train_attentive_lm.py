...
model_name = "att2_lstm_2lr_emb_512_hid512_proj256_en10000_batch128_steps20_maxNrm5_adam_0-001_dropout-off_input-feed-off-data-PTB"
dir = "/home/gian/"
...
flags.DEFINE_integer('start_decay', 6, 'Start learning rate decay at this epoch. Set to 0 to use patience.')
...
flags.DEFINE_integer("num_steps", 20, "Maximum number of steps to unroll the network.")
...
flags.DEFINE_integer('early_stop_patience', 0, 'How many training steps to monitor. Set to 0 to ignore.')
flags.DEFINE_integer('early_stop_after_epoch', 0, 'Start monitoring early_stop after this epoch.')
flags.DEFINE_boolean('eval_after_each_epoch', False, 'Run eval after each epoch.')
flags.DEFINE_boolean('save_each_epoch', True, 'Whether ot nor to save at the end of each epoch.')
flags.DEFINE_boolean('save_best_model', False, 'Set to True to save the best model even if not using early stop.')
